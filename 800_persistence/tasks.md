...
| ID | Estado | Tarea |
|----|--------|-------|
| T-017 | `[ ]` | **(PRÓXIMA) Definir el alcance del Tracer Bullet / walking skeleton** (`D-015` Fase 1): qué peldaño (L0) de cada uno de los 14 flujos **y de las filas transversales `TR-1..TR-4`** (`D-020`) entra en la slice fina end-to-end sobre C1. Poblar la columna *Tracer Bullet* de `roadmap.md` con el detalle concreto de cada celda (flujos + transversales). Respetar los invariantes no deferibles de `D-020`. Insumo: los 14 briefs aprobados (escalera L0→Ln) + `000_general_process.md` + `methodology.md`/`principles.md` (= ambición Ln). |
